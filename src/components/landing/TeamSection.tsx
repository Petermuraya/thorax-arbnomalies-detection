      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 shadow-sm">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="px-4 py-2 bg-white rounded-full text-sm font-medium shadow-sm">Medical Imaging</div>
            <div className="px-4 py-2 bg-white rounded-full text-sm font-medium shadow-sm">AI Development</div>
            <div className="px-4 py-2 bg-white rounded-full text-sm font-medium shadow-sm">Healthcare IoT</div>
            <div className="px-4 py-2 bg-white rounded-full text-sm font-medium shadow-sm">Clinical Validation</div>
          </div>
        </div>
      </div>
    </section>
