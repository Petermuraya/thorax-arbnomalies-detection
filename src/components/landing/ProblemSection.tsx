    ...
    <section id="problem" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-red-50 p-6 rounded-xl transition-transform hover:scale-105">
          ...
          <div className="bg-purple-50 p-6 rounded-xl transition-transform hover:scale-105">
        ...
        <div className="mt-12 bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
