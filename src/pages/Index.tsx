...
import { ArrowDown, Shield, Shield as ShieldIcon } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 rounded-full overflow-hidden hero-gradient flex items-center justify-center mr-3">
                  <ShieldIcon className="h-6 w-6 text-white" />
                </div>
                <span className="text-2xl font-bold text-white">X-Ray Insight</span>
              </div>
